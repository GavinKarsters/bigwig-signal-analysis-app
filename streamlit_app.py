                    ...
                    try:
                        ...
                        if 'BigWig_Group' in sheet_df.columns and 'BED_File' in sheet_df.columns:
                            ...
                            profile_info = {
                                ...
                                'std_signal': sheet_df['Std_Signal'].values,
    ...
    if st.button("🚀 Run Analysis", type="primary", use_container_width=True):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            try:
                ...
                analysis_params = {
                    'plot_type': plot_type,
                    'y_max': y_max if plot_type in ["Boxplot", "All plots"] else None,
                    'extend_bp': extend_bp if plot_type in ["Boxplot", "All plots"] else None,
                ...
                if plot_type in ["Heatmap", "All plots"] and profile_data:
                    st.header("🔥 Heatmap Results")
                    try:
                        fig_heatmap = create_heatmap_plot(profile_data, custom_bigwig_names, custom_bed_names)
